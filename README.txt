  ...
  06/05/2013, v3.34:
  - implemented new E820h memory routine for multiple 001 memory blocks
  - added 8Ah memory call for machines that support it (Phoenix BIOS)
  - corrected version numbering bug

  04/27/2008, v3.33:
  - Protected Mode switch fix for 386/486
  ...
  - TASM compatibility abandoned (didn't work with v3.31 either). Instead
    source is now compatible with WASM v1.7j.
